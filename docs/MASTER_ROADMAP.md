...
| F7-22 | **REDEFINIDA 2x** (Drive descartado por analisis de viabilidad) — Cloudflare R2 External Clinical Storage con Supabase como fuente de verdad | 7 | **P0** | XL (1-2 sem) | F7-05,F7-06,F7-07,F7-08,F7-21 | EN PROGRESO (2026-09-03) — Fase 5 DONE (R2), Fase 6 DONE (tabla), Fase 7 DONE (Edge Functions), Fase 8 DONE (frontend + modal), Fase 9 DONE (pen-test 5/6 + thumbnails), pendiente: Fase 10 (cleanup), F7-31 (papelera), F7-22a/b (mime_type) |
