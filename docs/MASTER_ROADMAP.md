...
| F7-34 | Alinear Edge Functions con contexto multi-clínica activo | 7 | **P0/P1** | M (2-3 d) | F7-10, F7-22, F7-31, F7-32 | DONE (código 2026-09-22) — Edge Functions corregidas para usar clínica activa del JWT. Stack traces removidos. PHI sanitizada. 10 tests Deno creados. **PENDIENTE: validación en staging con tests reales.** Errores TypeScript preexistentes confirmados (no afectan runtime). |
