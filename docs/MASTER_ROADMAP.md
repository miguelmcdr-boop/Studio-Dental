...
| F7-34 | Alinear Edge Functions con contexto multi-clínica activo | 7 | **P0/P1** | M (2-3 d) | F7-10, F7-22, F7-31, F7-32 | DONE (código 2026-09-22) — 7 Edge Functions corregidas para usar user_metadata.clinica_id del JWT. Stack traces removidos. PHI sanitizada. 10 tests Deno creados. Deuda técnica F7-22 resuelta (deno check pasa limpio). **PENDIENTE VALIDACIÓN MANUAL antes de F7-29:** desplegar a staging, crear fixtures multi-clínica, ejecutar tests reales. |
