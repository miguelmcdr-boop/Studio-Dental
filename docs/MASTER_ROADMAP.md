...
| F7-22 | **REDEFINIDA 2x** (Drive descartado por analisis de viabilidad) — Cloudflare R2 External Clinical Storage con Supabase como fuente de verdad | 7 | **P0** | XL (1-2 sem) | F7-05,F7-06,F7-07,F7-08,F7-21 | EN PROGRESO (2026-09-02) — Fase 5 DONE (infraestructura R2 validada), Fase 6 DONE (tabla archivos_clinicos con RLS), pendiente: Edge Functions upload/download, integracion frontend, pen-test |
