...
| F7-25 | Design System Studio Dental + App Shell profesional | 7 | P1 | L (4-7 d) | — | PARCIAL (2026-09-09) — MVP Fase 1+2 DONE + Iteración 1-8 DONE + Hotfix P0 DONE. Cobertura: 22/23 modales (96%), 31 componentes con Button, 24 con Input. Pendiente: Iteración 9 para 100% + push + PR + dark-sweep |
