...
| F7-25 | Design System Studio Dental + App Shell profesional | 7 | P1 | L (4-7 d) | — | PARCIAL (2026-09-09) — MVP Fase 1+2 DONE + Iteración 1-7 DONE + Hotfix P0 DONE. Cobertura: 20/23 modales (87%), 30 componentes con Button, 22 con Input. Pendiente: Iteración 8-9 para 100% + dark-sweep |
