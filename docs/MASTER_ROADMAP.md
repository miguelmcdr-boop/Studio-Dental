...
| F7-34 | Alinear Edge Functions con contexto multi-clínica activo | 7 | **P0/P1** | M (2-3 d) | F7-10, F7-22, F7-31, F7-32 | DONE (2026-09-22) — Edge Functions R2 corregidas para usar `user_metadata.clinica_id` (clínica activa del JWT) en lugar de `clinicaResult[0]` (primera membresía). Stack traces removidos de respuestas HTTP. PHI sanitizada en audit_log. 10 tests Deno de escenario multi-clínica. 7 archivos modificados, 438 inserciones, 32 eliminaciones. |
