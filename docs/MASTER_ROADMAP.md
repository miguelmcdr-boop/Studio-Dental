...
| F7-11 | Onboarding miembros: admin invita via link (MVP), registro libre con invitación | 7 | P1 | M (3-5 d) | F7-10 | IN PROGRESS |
| F7-11b | Bootstrap de clínica nueva (self-service): registro crea clínica + admin inicial | 7 | P1 | M (2-3 d) | F7-11 | TODO |
