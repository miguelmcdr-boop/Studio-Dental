...
| F7-34 | Alinear Edge Functions con contexto multi-clínica activo | 7 | **P0/P1** | M (2-3 d) | F7-10, F7-22, F7-31, F7-32 | TODO — Edge Functions R2 usan clinicaResult[0].clinica_id (primera membresía) en lugar de clinica_actual() (clínica activa). Viola arquitectura F7-10, permite operar sobre clínica incorrecta. Incluye: corrección de 6 Edge Functions, eliminación de stack traces en HTTP, sanitización de PHI en logs/audit_log, tests multi-clínica. |
