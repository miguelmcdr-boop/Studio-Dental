...
| F7-25 | Design System Studio Dental + App Shell profesional | 7 | P1 | L (4-7 d) | — | PARCIAL (2026-09-08) — MVP Fase 1+2 DONE + Iteración 1-6 DONE + Hotfix P0 DONE (dark-variant + spacing tokens + overlay v4 + labels dupes). Cobertura: 18/23 modales (78%), 29 componentes con Button, 21 con Input. Pendiente: dark-sweep + Iteración 7-9 para 100% |
