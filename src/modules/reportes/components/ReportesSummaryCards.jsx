  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-4 gap-4 text-xs">
      ...
      <div className="p-4 bg-emerald-50 border border-emerald-200 rounded-2xl shadow-xs">
        <span className="text-[10px] font-bold text-emerald-800 uppercase tracking-wider block">Tasa Conversión Presupuestos</span>
      ...
      <div className="p-4 bg-blue-50 border border-blue-200 rounded-2xl shadow-xs">
        <span className="text-[10px] font-bold text-blue-800 uppercase tracking-wider block">Ticket Promedio / Paciente</span>
      ...
      <div className="p-4 bg-purple-50 border border-purple-200 rounded-2xl shadow-xs">
        <span className="text-[10px] font-bold text-purple-800 uppercase tracking-wider block">Tratamientos Prescritos</span>
        <span className="text-2xl font-black text-purple-900 mt-1 block">
          {metricas.totalProcedimientos} Procedimientos
        </span>
      </div>
    </div>
  )
...
ReportesSummaryCards.displayName = 'ReportesSummaryCards'