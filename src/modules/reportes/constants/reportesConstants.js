...
export const ESPECIALIDADES_COLOR = {
  ...
  'Cirugía Bucal y Maxilofacial': 'bg-red-500',
  'Rehabilitación y Prótesis': 'bg-amber-500',
  'Implantología': 'bg-indigo-500',
  'Ortodoncia': 'bg-pink-500',
  'Periodoncia': 'bg-teal-500',
  'Odontopediatría': 'bg-cyan-500',
  'General': 'bg-gray-500'
}