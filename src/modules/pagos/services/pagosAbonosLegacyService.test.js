...
describe('pagosAbonosLegacyService — métodos legacy (extraídos de pagosStorageService)', () => {
  ...
  describe('sincronizarAbonoConFichaPaciente (dedup)', () => {
    it('no duplica abonos con el mismo id al sincronizar dos veces', () => {
      ...
      sincronizarAbonoConFichaPaciente(42, {
        id: 100,
        fecha: '02/01/2026',
        monto: 50000,
        metodoPago: 'Efectivo',
  ...
  describe('removerAbonoDeFichaPaciente', () => {
    it('retorna true y filtra el abono si existe', () => {
      ...
      const result = removerAbonoDeFichaPaciente(42, 100)
    ...
    it('retorna false si el abono no existía', () => {
      ...
      const result = removerAbonoDeFichaPaciente(42, 999)
    ...
    it('retorna false si pacienteId es nulo', () => {
      const result = removerAbonoDeFichaPaciente(null, 100)
      expect(result).toBe(false)
    })
  })
})
