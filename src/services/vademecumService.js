...
const DATOS_RESPALDO_MINIMOS = [
  ...
  { numero: 4, familia: 'anestesico_amida', nombre_generico: 'Bupivacaína 0.5% + Epinefrina 1:200.000', presentacion: 'Tubos 1.8 ml', posologia_adulto: 'Infiltrativa / Troncular', posologia_pediatrica: null, dosis_max_adulto_mg: 90, dosis_max_pediatrica_mg_por_kg: null, contenido_por_unidad_mg: 9, volumen_por_unidad_ml: 1.8, concentracion_mg_por_ml: 5, dosis_max_adulto_mg_por_kg: 1.3, dosis_max_pediatrica_mg: 50, contraindicaciones: 'Cardiopatía isquémica severa, niños <12 años, arritmias', alergias_cruzadas: ['otras_amidas', 'sulfitos'] },
